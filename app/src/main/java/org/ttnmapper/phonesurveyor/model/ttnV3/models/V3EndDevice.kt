 ...
 * @param recentAdrUplinks 
 * @param recentUplinks Recent uplink messages sorted by time. Stored in Network Server. The number of messages stored may depend on configuration.
 * @param recentDownlinks Recent downlink messages sorted by time. Stored in Network Server. The number of messages stored may depend on configuration.
...
data class V3EndDevice (
    ...
    val lorawanPhyVersion: V3PHYVersion? = null,
    ...
    val powerState: V3PowerState? = null,
    ...
    @Json(name = "recent_adr_uplinks")
    val recentAdrUplinks: kotlin.collections.List<V3UplinkMessage>? = null,
