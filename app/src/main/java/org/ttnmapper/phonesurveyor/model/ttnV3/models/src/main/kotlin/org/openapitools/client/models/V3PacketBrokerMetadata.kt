 ...
 * @param forwarderClusterId Forwarder Cluster ID of the Packet Broker Forwarder.
 * @param forwarderGatewayEui Forwarder gateway EUI.
 * @param forwarderGatewayId Forwarder gateway ID.
 ...
 * @param homeNetworkClusterId Home Network Cluster ID of the Packet Broker Home Network.
...
data class V3PacketBrokerMetadata (
    ...
    @Json(name = "forwarder_cluster_id")
    val forwarderClusterId: kotlin.String? = null,

    /* Forwarder gateway EUI. */
    @Json(name = "forwarder_gateway_eui")
    val forwarderGatewayEui: kotlin.ByteArray? = null,

    /* Forwarder gateway ID. */
    @Json(name = "forwarder_gateway_id")
    val forwarderGatewayId: kotlin.String? = null,
