...
import org.openapitools.client.models.ClaimEndDeviceRequestAuthenticatedIdentifiers
...
data class V3ClaimEndDeviceRequest (
    ...
    val authenticatedIdentifiers: ClaimEndDeviceRequestAuthenticatedIdentifiers? = null,
    @Json(name = "qr_code")
