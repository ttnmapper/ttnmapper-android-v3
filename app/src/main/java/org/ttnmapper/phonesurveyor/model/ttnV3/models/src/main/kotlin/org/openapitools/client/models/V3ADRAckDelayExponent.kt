...
enum class V3ADRAckDelayExponent(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is V3ADRAckDelayExponent) "$data" else null

        /**
         * Returns a valid [V3ADRAckDelayExponent] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): V3ADRAckDelayExponent? = data?.let {
